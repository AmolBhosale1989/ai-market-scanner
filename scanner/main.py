...
def run(refresh_universe: bool = False, limit: int | None = None, top_n: int = TOP_N):
    ...
    stage_rank = {"CONFIRMED": 4, "ARMED": 3, "FORMING": 2, "DISCOVER": 1, "REJECT": 0}
    ...
    cols = ["ticker", "price", "stage", "pattern", "rank_score", "rs20_vs_spy", "rvol", "entry_trigger", "stop", "target_8", "rr_to_8pct", "decision"]
